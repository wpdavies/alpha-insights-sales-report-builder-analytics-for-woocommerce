...
<?php if ( $license_status === 'expired' ) : ?>
	<div class="wpd-white-block">
		<div class="wpd-section-heading"><?php _e( 'Your License Has Expired', 'wpd-alpha-insights' ); ?></div>
		<p><?php _e( 'Looks like your license has expired, to resume your profit reporting you will need to renew your license.', 'wpd-alpha-insights' ); ?></p>
		<p><strong><?php _e( 'Use code "RENEWAL20" to take 20% off your next payment.', 'wpd-alpha-insights' ); ?></strong></p>
		<p><a href="https://wpdavies.dev/my-account/subscriptions/?utm_campaign=Expired+License&utm_source=Alpha+Insights+Plugin" class="wpd-input button button-primary wpd-license-action" target="_blank"><?php _e( 'Click here to renew', 'wpd-alpha-insights' ); ?></a></p>
	</div>
<?php endif; ?>
<div class="wpd-wrapper">
	<div class="wpd-section-heading wpd-inline">
		Alpha Insights <?php _e( 'License Manager', 'wpd-alpha-insights' ); ?>
		<?php submit_button( __( 'Save Changes', 'wpd-alpha-insights' ), 'wpd-input primary pull-right', 'submit', false ); ?>
...
<div class="wpd-wrapper">
	<table class="wpd-table fixed widefat">
		<thead>
			<tr>
				<th><?php _e( 'Your License', 'wpd-alpha-insights' ); ?></th>
				<td><?php _e( 'License Status:', 'wpd-alpha-insights' ); ?> <strong class="wpd-license-status"><?php echo $license_status; ?></strong> <?php echo $license_action ?></td>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>
					<label><?php _e( 'Your License Key', 'wpd-alpha-insights' ); ?></label>
					<div class="wpd-meta"><?php _e( 'Enter the license key provided to you on purchase, this can be found in your order confirmation email or in your account area on', 'wpd-alpha-insights' ); ?> <a href="https://wpdavies.dev/my-account/orders/?utm_campaign=Alpha+Insights+License&utm_source=Alpha+Insights+Plugin" target="_blank">WP Davies</a>.</div>
				</td>
			...
			<tr>
				<td><?php _e( 'License Status', 'wpd-alpha-insights' ); ?></td>
				<td><?php echo ( isset( $license_details['license_status'] ) ) ? $license_details['license_status'] : null; ?></td>
			</tr>
			<tr>
				<td><?php _e( 'License Owner', 'wpd-alpha-insights' ); ?></td>
			...
			<tr>
				<td>
					<?php _e( 'Last Updated', 'wpd-alpha-insights' ); ?>
			...
			<tr>
				<td><?php _e( 'Manage Your License', 'wpd-alpha-insights' ); ?><div class="wpd-meta"><?php _e( 'Visit your account area on WP Davies to manage your license.', 'wpd-alpha-insights' ); ?></div></td>
				<td><a href="https://wpdavies.dev/my-account/?utm_campaign=Alpha+Insights+Manage+License&utm_source=Alpha+Insights+Plugin" target="_blank" class="wpd-input button button-secondary"><?php _e( 'Manage Your License', 'wpd-alpha-insights' ); ?></a></td>
			</tr>
		</tbody>
	</table>
</div>
