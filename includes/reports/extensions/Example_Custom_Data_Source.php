 ...
 *
 * IMPORTANT: This class extends WPD_Alpha_Insights_Data_Source_Base, which handles
 ...
 * @since 5.0.0
 */
class Example_Custom_Data_Source extends WPD_Alpha_Insights_Data_Source_Base {
    ...
    public function fetch_data( $filters, $data_warehouse = null ) {
        ...
        // NOTE: execution_time and memory_usage are automatically tracked and added by the data warehouse
        // Do NOT include them in your return array - they will be automatically added
        return array(
            'totals' => $totals,
            'categorized_data' => $categorized_data,
            'data_table' => $data_table,
            'data_by_date' => $data_by_date,
            'total_db_records' => 3, // Example: number of records processed
            // execution_time and memory_usage are automatically added - don't include them
        );
    }
 ...
 * @since 5.0.0
 */
new Example_Custom_Data_Source();